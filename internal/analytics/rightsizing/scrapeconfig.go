...
// WorkloadPodMetrics are the 1d metrics to federate for workload and pod right-sizing.
// Includes CPU/memory request, limit, usage, and recommendation at both granularities.
